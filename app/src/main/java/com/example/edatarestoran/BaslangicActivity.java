...
public class BaslangicActivity extends AppCompatActivity {
    ...
    Button btn_baslangicGiris, btn_baslangicKaydol, btn_restoranKaydi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_baslangicGiris = findViewById(R.id.btn_giris_baslangicActivity);
        btn_baslangicKaydol = findViewById(R.id.btn_kaydol_baslangicActivity);
        btn_restoranKaydi = findViewById(R.id.btn_restoranKayit_baslangicActivity);
        ...
        btn_restoranKaydi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(BaslangicActivity.this, RestoranKayitActivity.class));
            }
        });
